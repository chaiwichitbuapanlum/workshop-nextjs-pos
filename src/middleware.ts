...
/**
 * การกำหนดค่า config สำหรับ middleware
 * @description
 * กำหนด URL patterns ที่ middleware จะทำงาน:
 * - "/" : หน้าแรก
